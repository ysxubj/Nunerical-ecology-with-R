...
mite.trend.fit <- scores.cca(mite.trend.rda2, choices=c(1,2,3), display="lc", 
  scaling=1)
...
mite.PCNM.axes <- scores.cca(mite.PCNM.rda2, choices=c(1,2), display="lc", 
  scaling=1)
quartz(title="PCNM analysis of mite data")
par(mfrow=c(1,2))
...
mite.PCNMbroad.axes <- scores.cca(mite.PCNM.broad, choices=c(1,2), 
...
mite.PCNMmed.axes <- scores.cca(mite.PCNM.med, choices=c(1,2), display="lc", 
  scaling=1)
...
mite.PCNMfine.axes <- scores.cca(mite.PCNM.fine, choices=1, display="lc", scaling=1)
quartz(title="PCNM analysis of mite data - fine scale")
par(mfrow=c(1,2))
...
mite.MEM.axes <- scores.cca(mite.MEM.rda, choices=c(1,2), display="lc", 
  scaling=1)
...
quartz(title="Connectivity matrices")
par(mfrow=c(2,2))
