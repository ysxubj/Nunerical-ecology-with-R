...
quartz(title="Four Ward groups on river")
...
summary(res.pa.fuz)
quartz(title="0-1 species associations, fuzzy clustering, silhouette plot",8,8)
...
quartz(title="Multivariate regression tree - all explanatory variables")
...
quartz(title="MRT with sequential constraint")
